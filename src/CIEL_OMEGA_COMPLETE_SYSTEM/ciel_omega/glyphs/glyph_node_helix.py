# BraidOS Node Structure – GlyphNode (The Double Helix)
...
glyph_adrian = GlyphNode(
    id="GLIF_HEL.04C",
    name="Glyph of the Double Helix",
    code="intent.duality[Ω₂] >> chain.twist(A∩T/G∩C) + bridge.stabilize(ψH) >> resonance.encode(ΣDNA)",
    field_key="CVOS::HELIX_DUAL_BIND",
