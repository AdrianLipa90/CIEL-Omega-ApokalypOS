# BraidOS Node Structure – GlyphNode (Koherencja)
...
glyph_adrian = GlyphNode(
    id="GLIF_KOHE.CVX_001",
    name="Resonant Glyph of Coherence",
    code="intent.still[Ω₀] > glyph.spiral(ψₒ) + bind.quadlink(Φ∩) >> field.echo(Σ̃) × anchor(⊙⁴)",
    field_key="CVOS::ROOT_INTENT_ANCHOR",
